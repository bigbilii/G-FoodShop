...
public class Apriori2 {
     ...
     * @return
     */
    private static Map<String, Integer> findFrequentOneSets(List<String> dataList) {
        ...
        for (String s : resultSetMap.keySet()) {
            if (resultSetMap.get(s) < SUPPORT) {
                resultSetMap.remove(s);
            }
        }
        return resultSetMap;
    }
     ...
     * @return
     */
    private static Map<String, Integer> aprioriGen(Map<String, Integer> setMap) {
     ...
     * @return
     */
    private static boolean hasInfrequentSubset(String candidateSet, Map<String, Integer> setMap) {
